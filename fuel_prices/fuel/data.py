...
c.execute('''DROP TABLE IF EXISTS postcodes_geo''')
c.execute('''CREATE TABLE postcodes_geo (
  id integer NOT NULL,
...
c.execute('''INSERT INTO postcodes_geo (postcode, suburb, state, latitude, longitude) VALUES
...
''')
c.execute('SELECT * FROM postcodes_geo limit 1')
print(c.fetchone())
conn.commit()
